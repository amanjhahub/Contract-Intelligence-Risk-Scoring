...
def run_comparison():
    ...
    contract_a = extract_contract_text(contract_a_path)

    print("Reading Contract B...")
    contract_b = extract_contract_text(contract_b_path)
    ...
    comparison = compare_contracts(report_a, report_b)
    ...
    print(f"Contract B Risk Score : {comparison['contract_b_score']}")
    ...
    print(f"{comparison['better_contract']} is safer.")
